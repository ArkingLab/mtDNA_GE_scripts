...
wd <- '/Volumes/JHPCE/dcs01/active/projects/GTeX/syang/'
...
# SUBJECT
getwd()
phenotype <- read_delim("/Volumes/JHPCE/dcs01/active/projects/GTeX/syang/data_files/GTEx_v7_Subject_Phenotypes.GRU.n635_AnalysisFreeze.txt", "\t", escape_double = FALSE, trim_ws = TRUE)
