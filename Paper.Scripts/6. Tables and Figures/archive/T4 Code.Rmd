...
# This script will look at GO pathways significant in multiple tissues! Adapted from /Volumes/JHPCE/dcs01/active/projects/GTeX/syang/look.version8/GO_enrich/Test.GO.all.tissues/tabulate.cross.tissue.GO.nopseudo.R
```{r setup}
library(data.table)
library(knitr)
library(ggplot2)
...
# 
# load('/Volumes/JHPCE/dcs01/active/projects/GTeX/syang/look.version8/Whole Blood/sig.pathways.nopseudo.permutecut.rds')
...
# 	char <- all_tissues[i]
# 	wd <- paste0('/Volumes/JHPCE/dcs01/active/projects/GTeX/syang/look.version8/', char)
...
# }
# 
# save(big.sig.pathways, file = '/Volumes/JHPCE/dcs01/active/projects/GTeX/syang/look.version8/R_code/Cross.tissue.look/big.sig.pathways.nopseudo.permutecut.rds')

load('/Volumes/JHPCE/dcs01/active/projects/GTeX/syang/look.version8/R_code/Cross.tissue.look/big.sig.pathways.permutecut_1000.rds')
```
...
save(only.sig.tissues, file = '/Volumes/JHPCE/dcs01/active/projects/GTeX/syang/look.version8/R_code/Cross.tissue.look/only.sig.tissues_1000.rds')
```
