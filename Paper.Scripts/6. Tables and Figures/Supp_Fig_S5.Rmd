...
```{r setup}
library(data.table)
# wdir <- paste0('/Volumes/JHPCE/dcs01/active/projects/GTeX/syang/look.version8/new.permutation.method/Whole Blood')
...
# actual plotting
```{r}
png(file = '/dcs01/arking/arkinglab/active/projects/GTeX/syang/look.version8/pval_plot.png', width = 600, height = 400, units = 'px')
