...
load('/Volumes/JHPCE/dcs01/active/projects/GTeX/syang/look.version8/R_code/Cross.tissue.look/big.sig.pathways.nopseudo.permutecut.rds')
```
...
save(only.sig.tissues, file = '/Volumes/JHPCE/dcs01/active/projects/GTeX/syang/look.version8/R_code/Cross.tissue.look/only.sig.tissues.rds')
```
