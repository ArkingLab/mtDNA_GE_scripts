...
library(htmlTable)
htmlTable(show, rnames = rep('', nrow(show)), header = c('Covariate', 'GTEx effect size estimate', 'GTEx standard error', 'GTEx p-value', 'ARIC effect size estimate', 'ARIC standard error', 'ARIC p-value', 'Power'))
```