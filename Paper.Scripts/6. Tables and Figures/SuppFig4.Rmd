...
```{r setup}
library(data.table)
wdir <- paste0('/Volumes/JHPCE 1/dcs01/active/projects/GTeX/syang/look.version8/new.permutation.method/Whole Blood')
setwd(wdir)
...
load('/Volumes/JHPCE 1/dcs01/active/projects/GTeX/syang/look.version8/Whole Blood/with.gene.rds')
```
