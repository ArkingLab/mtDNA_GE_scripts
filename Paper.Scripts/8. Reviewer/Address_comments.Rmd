...
# Check 1000
```{r}
setwd('/Volumes/JHPCE/dcs01/active/projects/GTeX/syang/look.version8/new.permutation.method/Whole Blood/')
pval = list.files()
...
```{r}
load('/Volumes/JHPCE/dcs01/active/projects/GTeX/syang/look.version8/Whole Blood/with.gene.noINT.rds')
no.int = with.gene
load('/Volumes/JHPCE/dcs01/active/projects/GTeX/syang/look.version8/Whole Blood/with.gene.rds')
int = with.gene
load('/Volumes/JHPCE/dcs01/active/projects/GTeX/syang/look.version8/Whole Blood/with.gene.noSCALE.rds')
noscale = with.gene
